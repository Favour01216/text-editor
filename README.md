...
This single-page text editor operates in a browser and satisfies the PWA requirements. In case one of the choices is not supported by the browser, it has a variety of redundancy data persistence strategies. The programme runs offline and is installed on Heroku.
[Deplayed page link!](https://text-editorrrr.herokuapp.com/)
## Table of Contents
  1. [Title](#title)
